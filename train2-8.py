"""
    This program will train a particular dataset using a pre-trained model. User can input which pretrained model to use,
    number of epochs, learning rate, and number of hidden layers.
    The program will print the accuracy, training loss, and validation loss.
    
    Pre-trained models: vgg16, vgg19, vgg11, vgg13
    
    Command Line:
    python train.py data_dir --arch vgg16 --epochs 5
