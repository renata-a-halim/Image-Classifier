...
def predict(image_path, model, top_k,cat_to_name, device='gpu'):
    ...
    top_probability, indices = torch.topk(probability, dim=1, k=top_k)
...
def main():
    ...
    #Prediction
    top_probability, names = predict(args.image_path, model, args.top_k, args.cat_to_name, device='gpu')
