...
def train_model(model, train_dataset, train_loader, valid_loader, optimizer, criterion, epochs=1, device='cuda'):
...
def save_checkpoint(model, save_dir, optimizer, arch='vgg16', hidden_units=4096, epochs=1):
    checkpoint = {
        'arch': arch,
...
def main():
    ...
    model = train_model(model, train_dataset, train_loader, valid_loader, optimizer, criterion, epochs=1, device='cuda')
    
    #test the model
    
    #save the model
    checkpoint = save_checkpoint(model, args.save_dir, optimizer, arch='vgg16', hidden_units=4096, epochs=1, )
